...
if (!defined ("_JUMBLE_GAME_CONSTANTS_"))
{
	...
	define("DB_HOST", 'guesstheword.db.5679346.hostedresource.com');
	define("DB_USERNAME", 'guesstheword');
	define("DB_PASSWORD", 'Guess123');

	/* 'guesstheword' db tables */
	define("TABLE_USERS_TO_CONFIRM", 'users_to_confirm');
	...
	define("COLUMN_IS_ACTIVATED", 'isActivated');
	define("COLUMN_ACTIVATION_CODE", 'activationCode');
	...
	define("SIGN_UP_SUCCESS", 'Sign up successful. A confirmation Email has been sent to ');
	define("ACCOUNT_VERIFIED", 'The account has been verfied successfully');
	define("CONFIRMATION_MAIL_SUBJECT", 'Your confirmation link here');
	define("CONFIRMATION_MAIL_HEADER", 'from: your name <your email>');
	define("CONFIRMATION_MAIL_DELIVERY_FAILURE", 'from: your name <your email>');
	define("INVALID_ACTIVATION_CODE", 'The confirmation code is expired or invalid');
	define("ADDING_ONLINE_USER_SUCCESS", 'User online');
	define("ADDING_ONLINE_USER_FAILED", 'User offline');
	define("RETRIEVING_ACTIVE_USERS_SUCCESS", 'Success getting a list of random active users');
	define("RETRIEVING_ACTIVE_USERS_FAILURE", 'Error getting a list of random active users');
